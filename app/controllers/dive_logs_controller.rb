class DiveLogsController < ApplicationController
    ...
    def index 
        ...
        render json: dive_logs, status: :202 
    end 
    ...
    def dive_log_params 
        params.permit(:dive_number, :dive_site_name, :dive_site_country, :date, :time_in, :time_out, :depth, :starting_psi, :ending_psi, :air_temp, :surface_temp, :bottom_temp, :fresh_or_salt_water, :shore_or_boat, :training_dive, :diver_id, :diver_site_id)
    end
end
