...
function AboutApp(){
    ...
    return(
        <div id='aboutpage'>
            ...
            <div>
                    <img src="https://user-images.githubusercontent.com/106715328/193474681-1b73c208-3102-4e93-bfc0-9222d40d6de9.jpg" alt="" className="h-42 w-2/4 container mx-auto rounded-2xl m-6 border-4 border-blue-800"/>
            </div>
            <div className="h-96 w-2/4 container mx-auto">
