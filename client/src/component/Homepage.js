        ...
        <div className='bg-[url(https://user-images.githubusercontent.com/106715328/193144399-3c5219b0-ba6a-4567-b7e6-bdd045df1053.jpg)] min-h-screen w-full bg-cover bg-center p-1'>
            <div>
                ...
                <Card>
                    ...
                    about popular dive sites, including the different species of animals and corals native to sites. The Caribbean sea is one of the jewels of our oceans. The coral reefs sprinkled all throughout the Caribbean are exploding with biodiversity. Undoubtedly a must see for any avid scuba divers. The hope of this app is to eventually include other dive sites around the world 
                    but to start, it will focus on the beauty and majesty of the Caribbean. With the rich biodiversity, there are many animals/corals that are completely harmless to divers; however, there are animals and corals that are present in the Caribbean that can cause serious injury or even death. 
