    ...
    <div id='homepage'>
        <div className='bg-[url(https://user-images.githubusercontent.com/106715328/193144399-3c5219b0-ba6a-4567-b7e6-bdd045df1053.jpg)] min-h-screen w-full bg-cover bg-center p-1'>
            <div>
                ...
                <h1 className='text-blue-700 text-5xl font-bold mt-4 text-center pb-1'>Welcome to Scuba Pocket Guide!</h1>
                <h2 className="text-blue-700 text-3xl font-bold mt-4 text-center pt-0 pb-6"> Your one-stop shop for aquatic wildlife, dive sites, and so much more</h2>
